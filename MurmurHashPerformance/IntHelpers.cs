...
namespace MurmurHashPerformance
{
    ...
    public static class IntHelpers
    {
        ...
        /// <summary>
        /// Win32 API for convert long filesize to string like xxMB xxKB..
        /// </summary>
        /// <param name="filesize"></param>
        /// <returns></returns>
        public static string ConverFilesizeFormat(long filesize)
        {
            return StrFormatByteSize(filesize);
        }

        public static string ConverFilesizeFormat(Decimal filesize)
        {
            return StrFormatByteSize(filesize);
        }
        /// <summary>
        /// the C# version of win32 StrFormatByteSize
        /// </summary>
        /// <param name="filesize"></param>
        /// <returns></returns>
        ...
        public static string StrFormatByteSize(Decimal filesize)
        {
            Decimal size = Convert.ToDecimal(filesize);
